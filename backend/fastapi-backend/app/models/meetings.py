...
class Meeting(UUIDMixin, TimestampMixin, Base):
    ...
    body_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("bodies.id", ondelete="SET NULL"))
...
class MeetingPermission(Base):
    ...
    meeting_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("meetings.id", ondelete="CASCADE"), primary_key=True)
...
class AgendaItem(UUIDMixin, Base):
    ...
    meeting_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("meetings.id", ondelete="CASCADE"), nullable=False)
    parent_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("agenda_items.id", ondelete="CASCADE"))
    position: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    title: Mapped[str] = mapped_column(String(255), nullable=False)
    description: Mapped[Optional[str]] = mapped_column(Text)
    linked_policy_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True))
    linked_objective_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True))
...
class AgendaWorkflowStep(UUIDMixin, Base):
    ...
    workflow_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("agenda_workflows.id", ondelete="CASCADE"), nullable=False)
    ...
    approver_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True))
...
class AgendaItemApproval(UUIDMixin, Base):
    ...
    item_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("agenda_items.id", ondelete="CASCADE"), nullable=False)
    step_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("agenda_workflow_steps.id", ondelete="CASCADE"), nullable=False)
    approver_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("users.id"))
...
class Motion(UUIDMixin, Base):
    ...
    agenda_item_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("agenda_items.id", ondelete="CASCADE"), nullable=False)
    text: Mapped[str] = mapped_column(Text, nullable=False)
    moved_by_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("users.id"))
    seconded_by_id: Mapped[Optional[UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("users.id"))
...
class Vote(UUIDMixin, Base):
    __tablename__ = "votes"
    motion_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("motions.id", ondelete="CASCADE"), nullable=False)
    voter_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("users.id"), nullable=False)
...
class AgendaItemFile(Base):
    ...
    agenda_item_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("agenda_items.id", ondelete="CASCADE"), primary_key=True)
    file_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("files.id", ondelete="CASCADE"), primary_key=True)
    caption: Mapped[Optional[str]] = mapped_column(String(255))
...
class MeetingSearchIndex(Base):
    ...
    meeting_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("meetings.id", ondelete="CASCADE"), primary_key=True)
    ts: Mapped[Optional[str]] = mapped_column(TSVECTOR)  # ORM placeholder
