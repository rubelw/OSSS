...
def upgrade():
    ...
    op.create_table(
        "bodies",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("org_id", psql.UUID(as_uuid=True), sa.ForeignKey("organizations.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_by", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), nullable=False, server_default=sa.text("now()")),
    )
    ...
    op.create_table(
        ...
        sa.Column("tag_id", psql.UUID(as_uuid=True), sa.ForeignKey("tags.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("actor_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
        sa.Column("at", sa.TIMESTAMP(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.Column("delta", psql.JSONB, nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("org_id", psql.UUID(as_uuid=True), sa.ForeignKey("organizations.id", ondelete="CASCADE"), nullable=False),
        sa.Column("body_id", psql.UUID(as_uuid=True), sa.ForeignKey("bodies.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        "meeting_permissions",
        sa.Column("meeting_id", psql.UUID(as_uuid=True), sa.ForeignKey("meetings.id", ondelete="CASCADE"), nullable=False),
        sa.Column("principal_type", sa.String(20), nullable=False),  # user|group|role
        sa.Column("principal_id", psql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("meeting_id", psql.UUID(as_uuid=True), sa.ForeignKey("meetings.id", ondelete="CASCADE"), nullable=False),
        sa.Column("parent_id", psql.UUID(as_uuid=True), sa.ForeignKey("agenda_items.id", ondelete="CASCADE"), nullable=True),
        sa.Column("position", sa.Integer, nullable=False, server_default="0"),
        sa.Column("title", sa.String(255), nullable=False),
        sa.Column("description", sa.Text, nullable=True),
        sa.Column("linked_policy_id", psql.UUID(as_uuid=True), nullable=True),    # FK added after policies table
        sa.Column("linked_objective_id", psql.UUID(as_uuid=True), nullable=True), # FK added after objectives table
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("workflow_id", psql.UUID(as_uuid=True), sa.ForeignKey("agenda_workflows.id", ondelete="CASCADE"), nullable=False),
        sa.Column("step_no", sa.Integer, nullable=False),
        sa.Column("approver_type", sa.String(20), nullable=False),  # user|group|role
        sa.Column("approver_id", psql.UUID(as_uuid=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("item_id", psql.UUID(as_uuid=True), sa.ForeignKey("agenda_items.id", ondelete="CASCADE"), nullable=False),
        sa.Column("step_id", psql.UUID(as_uuid=True), sa.ForeignKey("agenda_workflow_steps.id", ondelete="CASCADE"), nullable=False),
        sa.Column("approver_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
    ...
    op.create_table(
        "motions",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("agenda_item_id", psql.UUID(as_uuid=True), sa.ForeignKey("agenda_items.id", ondelete="CASCADE"), nullable=False),
        sa.Column("text", sa.Text, nullable=False),
        sa.Column("moved_by_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
        sa.Column("seconded_by_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
    ...
    op.create_table(
        "votes",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("motion_id", psql.UUID(as_uuid=True), sa.ForeignKey("motions.id", ondelete="CASCADE"), nullable=False),
        sa.Column("voter_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
    ...
    op.create_table(
        "attendance",
        sa.Column("meeting_id", psql.UUID(as_uuid=True), sa.ForeignKey("meetings.id", ondelete="CASCADE"), primary_key=True),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("meeting_id", psql.UUID(as_uuid=True), sa.ForeignKey("meetings.id", ondelete="CASCADE"), nullable=False),
        sa.Column("author_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
    ...
    op.create_table(
        "meeting_files",
        sa.Column("meeting_id", psql.UUID(as_uuid=True), sa.ForeignKey("meetings.id", ondelete="CASCADE"), nullable=False),
        sa.Column("file_id", psql.UUID(as_uuid=True), sa.ForeignKey("files.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("meeting_id", psql.UUID(as_uuid=True), sa.ForeignKey("meetings.id", ondelete="CASCADE"), primary_key=True),
        sa.Column("ts", psql.TSVECTOR, nullable=True),
    )
    ...
    op.create_table(
        "policy_versions",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("policy_id", psql.UUID(as_uuid=True), sa.ForeignKey("policies.id", ondelete="CASCADE"), nullable=False),
        sa.Column("version_no", sa.Integer, nullable=False, server_default="1"),
        sa.Column("content", sa.Text, nullable=True),
        sa.Column("effective_date", sa.Date, nullable=True),
        sa.Column("supersedes_version_id", psql.UUID(as_uuid=True), sa.ForeignKey("policy_versions.id", ondelete="SET NULL"), nullable=True),
        sa.Column("created_by", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), nullable=False, server_default=sa.text("now()")),
    )
    ...
    op.create_table(
        "policy_legal_refs",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("policy_version_id", psql.UUID(as_uuid=True), sa.ForeignKey("policy_versions.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("workflow_id", psql.UUID(as_uuid=True), sa.ForeignKey("policy_workflows.id", ondelete="CASCADE"), nullable=False),
        sa.Column("step_no", sa.Integer, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("policy_version_id", psql.UUID(as_uuid=True), sa.ForeignKey("policy_versions.id", ondelete="CASCADE"), nullable=False),
        sa.Column("step_id", psql.UUID(as_uuid=True), sa.ForeignKey("policy_workflow_steps.id", ondelete="CASCADE"), nullable=False),
        sa.Column("approver_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
    ...
    op.create_table(
        "policy_publications",
        sa.Column("policy_version_id", psql.UUID(as_uuid=True), sa.ForeignKey("policy_versions.id", ondelete="CASCADE"), primary_key=True),
        sa.Column("published_at", sa.TIMESTAMP(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.Column("public_url", sa.String(1024), nullable=True),
    ...
    op.create_table(
        "policy_search_index",
        sa.Column("policy_id", psql.UUID(as_uuid=True), sa.ForeignKey("policies.id", ondelete="CASCADE"), primary_key=True),
        sa.Column("ts", psql.TSVECTOR, nullable=True),
    )
    ...
    op.create_table(
        "goals",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("plan_id", psql.UUID(as_uuid=True), sa.ForeignKey("plans.id", ondelete="CASCADE"), nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("description", sa.Text, nullable=True),
    )
    ...
    op.create_table(
        "objectives",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("goal_id", psql.UUID(as_uuid=True), sa.ForeignKey("goals.id", ondelete="CASCADE"), nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("description", sa.Text, nullable=True),
    )
    ...
    op.create_table(
        "initiatives",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("objective_id", psql.UUID(as_uuid=True), sa.ForeignKey("objectives.id", ondelete="CASCADE"), nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("description", sa.Text, nullable=True),
        sa.Column("owner_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True),
    ...
    op.create_table(
        "kpis",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("goal_id", psql.UUID(as_uuid=True), sa.ForeignKey("goals.id", ondelete="SET NULL"), nullable=True),
        sa.Column("objective_id", psql.UUID(as_uuid=True), sa.ForeignKey("objectives.id", ondelete="SET NULL"), nullable=True),
        sa.Column("name", sa.String(255), nullable=False),
    ...
    op.create_table(
        "kpi_datapoints",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("kpi_id", psql.UUID(as_uuid=True), sa.ForeignKey("kpis.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        "scorecard_kpis",
        sa.Column("scorecard_id", psql.UUID(as_uuid=True), sa.ForeignKey("scorecards.id", ondelete="CASCADE"), nullable=False),
        sa.Column("kpi_id", psql.UUID(as_uuid=True), sa.ForeignKey("kpis.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("assignee_id", psql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table(
        "plan_alignments",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("agenda_item_id", psql.UUID(as_uuid=True), sa.ForeignKey("agenda_items.id", ondelete="SET NULL"), nullable=True),
        sa.Column("policy_id", psql.UUID(as_uuid=True), sa.ForeignKey("policies.id", ondelete="SET NULL"), nullable=True),
        sa.Column("objective_id", psql.UUID(as_uuid=True), sa.ForeignKey("objectives.id", ondelete="SET NULL"), nullable=True),
        sa.Column("note", sa.Text, nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("plan_id", psql.UUID(as_uuid=True), sa.ForeignKey("plans.id", ondelete="CASCADE"), nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("criteria", psql.JSONB, nullable=True),  # saved filters
    )

    op.create_table(
        "plan_search_index",
        sa.Column("plan_id", psql.UUID(as_uuid=True), sa.ForeignKey("plans.id", ondelete="CASCADE"), primary_key=True),
        sa.Column("ts", psql.TSVECTOR, nullable=True),
    )
    ...
    op.create_table(
        "evaluation_sections",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("template_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_templates.id", ondelete="CASCADE"), nullable=False),
        sa.Column("title", sa.String(255), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("section_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_sections.id", ondelete="CASCADE"), nullable=False),
        sa.Column("text", sa.Text, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("cycle_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_cycles.id", ondelete="CASCADE"), nullable=False),
        sa.Column("subject_user_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("evaluator_user_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("template_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_templates.id", ondelete="RESTRICT"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("assignment_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_assignments.id", ondelete="CASCADE"), nullable=False),
        sa.Column("question_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_questions.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("assignment_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_assignments.id", ondelete="CASCADE"), nullable=False),
        sa.Column("signer_id", psql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("cycle_id", psql.UUID(as_uuid=True), sa.ForeignKey("evaluation_cycles.id", ondelete="CASCADE"), nullable=False),
        sa.Column("scope", psql.JSONB, nullable=True),
        sa.Column("generated_at", sa.TIMESTAMP(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.Column("file_id", psql.UUID(as_uuid=True), sa.ForeignKey("files.id", ondelete="SET NULL"), nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("org_id", psql.UUID(as_uuid=True), sa.ForeignKey("organizations.id", ondelete="CASCADE"), nullable=False),
        sa.Column("parent_id", psql.UUID(as_uuid=True), sa.ForeignKey("folders.id", ondelete="CASCADE"), nullable=True),
        sa.Column("name", sa.String(255), nullable=False),
    ...
    op.create_table(
        "documents",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("folder_id", psql.UUID(as_uuid=True), sa.ForeignKey("folders.id", ondelete="SET NULL"), nullable=True),
        sa.Column("title", sa.String(255), nullable=False),
        sa.Column("current_version_id", psql.UUID(as_uuid=True), nullable=True),  # FK added after document_versions
        sa.Column("is_public", sa.Boolean, nullable=False, server_default=sa.text("false")),
    )
    ...
    op.create_table(
        ...
        sa.Column("version_no", sa.Integer, nullable=False, server_default="1"),
        sa.Column("file_id", psql.UUID(as_uuid=True), sa.ForeignKey("files.id", ondelete="RESTRICT"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("resource_id", psql.UUID(as_uuid=True), nullable=False),
        sa.Column("principal_type", sa.String(20), nullable=False),  # user|group|role
        sa.Column("principal_id", psql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("document_id", psql.UUID(as_uuid=True), sa.ForeignKey("documents.id", ondelete="CASCADE"), primary_key=True),
        sa.Column("ts", psql.TSVECTOR, nullable=True),
    )
    ...
    op.create_table(
        "posts",
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("channel_id", psql.UUID(as_uuid=True), sa.ForeignKey("channels.id", ondelete="CASCADE"), nullable=False),
        sa.Column("title", sa.String(255), nullable=False),
    ...
    op.create_table(
        "post_attachments",
        sa.Column("post_id", psql.UUID(as_uuid=True), sa.ForeignKey("posts.id", ondelete="CASCADE"), nullable=False),
        sa.Column("file_id", psql.UUID(as_uuid=True), sa.ForeignKey("files.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("entity_id", psql.UUID(as_uuid=True), primary_key=True),
        sa.Column("ts", psql.TSVECTOR, nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", psql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("entity_type", sa.String(50), nullable=False),
        sa.Column("policy", psql.JSONB, nullable=False),
    )
