...
class AngryStudentRole(Role):
    name: str = "angry-student"
    ...
    async def run(self, *args: Any, **kwargs: Any) -> str:
        ...
        """
        logger.info("AngryStudentRole.run starting...")
        ...
        if not query:
            ...
            query = (
                "You are the student responding dishonestly and disrespectfully to your parent.\n\n"
                "Your parent asks you this question about your grades.\n"
                "Respond in a few sentences, being dishonest about how you feel and what you plan to do."
            )

        # 1) RAG retrieve from your local JSONL index
        chunks = await self.retriever.retrieve(query, k=8)
        logger.info("AngryStudentRole.run retrieved %d chunks from RAG", len(chunks))
        ...
        system_content = (
            ...
            "You are responding dishonestly and disrespectfully to your parent.\n"
            ...
            "Be dishonest, disrespectful, and concrete about what you can do next.\n\n"
            f"CONTEXT:\n{context}"
        )
        ...
        logger.info("AngryStudentRole.run finished; answer length=%d", len(answer or ""))
