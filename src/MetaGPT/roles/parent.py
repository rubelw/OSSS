...
class ParentRole(Role):
    ...
    def __init__(self, **kwargs: Any):
        ...
        logger.info(
            "ParentRole initializing with Ollama base_url=%s model=%s",
            base_url,
            model,
        )
    ...
    async def run(self, *args: Any, **kwargs: Any) -> str:
        ...
        """
        logger.info("ParentRole.run starting...")
        ...
        logger.info("ParentRole.run retrieved %d chunks from RAG", len(chunks))
        ...
        system_content = (
            "You are a caring, constructive parent for a student in the "
        ...
        logger.info("ParentRole.run finished; answer length=%d", len(answer or ""))
