...
DEPARTMENTS: list[str] = [
    ...
    "Business Accounting",
    "Communications Pr Advancement",
    "Curriculum Instruction Assessment",
    "Data Sis Analytics",
    "Division Of Communications Engagement",
    "Division Of Finance",
    "Division Of Human Resources",
    "Division Of Operations",
    "Division Of Schools",
    "Division Of Teaching Learning Accountability",
    "Division Of Technology Data",
    "Early Childhood Extended Programs",
    "Facilities Maintenance",
    "Faith Based Religious If Applicable",
