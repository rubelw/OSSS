...
# Columns: meeting_id, published_at, public_url, archive_url
SEED_ROWS = [
    {
        "meeting_id": "89ab8c9b-8c20-5b36-95db-e4e7e0a5e3b4",
        "published_at": "2024-01-01T05:00:00Z",
        "public_url": (
            "https://public.dcgschools.org/board/meetings/"
            "2024-01-regular-meeting"
        ),
        "archive_url": (
            "https://public.dcgschools.org/board/meetings/"
            "2024-01-regular-meeting/packet.pdf"
        ),
    },
]
...
def upgrade() -> None:
    """Load seed data for meeting_publications from inline SEED_ROWS.
