...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_semantic_relation", "semantic_links", ["relation"], unique=False
    )
    op.create_index(
        "idx_semantic_to",
        "semantic_links",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["parent_topic_id"], ["ai_topics.id"]),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index("idx_topics_name", "ai_topics", ["name"], unique=False)
    op.create_index("idx_topics_parent", "ai_topics", ["parent_topic_id"], unique=False)
    op.create_table(
        "questions",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "idx_questions_correlation", "questions", ["correlation_id"], unique=False
    )
    op.create_index("idx_questions_created", "questions", ["created_at"], unique=False)
    op.create_index(
        "idx_questions_execution", "questions", ["execution_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_wiki_source_question", "wiki_entries", ["question_id"], unique=False
    )
    op.create_index("idx_wiki_supersedes", "wiki_entries", ["supersedes"], unique=False)
    op.create_index(
        "idx_wiki_topic_version", "wiki_entries", ["topic_id", "version"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index("idx_topics_parent", table_name="ai_topics")
    op.drop_index("idx_topics_name", table_name="ai_topics")
    op.drop_index(
        "idx_topics_embedding",
        table_name="ai_topics",
        postgresql_using="ivfflat",
        postgresql_ops={"embedding": "vector_cosine_ops"},
    )
