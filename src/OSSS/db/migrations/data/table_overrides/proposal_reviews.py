# table_overrides/proposal_reviews.py
import json
from __main__ import register_table_loader


@register_table_loader("proposal_reviews")
def load_proposal_reviews(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample proposal_reviews"
