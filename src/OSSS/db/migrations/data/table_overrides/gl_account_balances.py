# table_overrides/gl_account_balances.py
import json
from __main__ import register_table_loader


@register_table_loader("gl_account_balances")
def load_gl_account_balances(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample gl_account_balances"
