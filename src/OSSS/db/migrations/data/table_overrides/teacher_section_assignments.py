# table_overrides/teacher_section_assignments.py
import json
from __main__ import register_table_loader


@register_table_loader("teacher_section_assignments")
def load_teacher_section_assignments(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample teacher_section_assignments"
