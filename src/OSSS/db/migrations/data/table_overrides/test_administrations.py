# table_overrides/test_administrations.py
import json
from __main__ import register_table_loader


@register_table_loader("test_administrations")
def load_test_administrations(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample test_administrations"
