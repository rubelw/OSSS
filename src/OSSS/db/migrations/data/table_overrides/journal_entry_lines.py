# table_overrides/journal_entry_lines.py
import json
from __main__ import register_table_loader


@register_table_loader("journal_entry_lines")
def load_journal_entry_lines(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample journal_entry_lines"
