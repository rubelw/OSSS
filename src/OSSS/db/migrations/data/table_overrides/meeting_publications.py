# table_overrides/meeting_publications.py
import json
from __main__ import register_table_loader


@register_table_loader("meeting_publications")
def load_meeting_publications(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample meeting_publications"
