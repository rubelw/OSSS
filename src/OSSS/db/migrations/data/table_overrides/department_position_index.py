# table_overrides/department_position_index.py
import json
from __main__ import register_table_loader


@register_table_loader("department_position_index")
def load_department_position_index(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample department_position_index"
