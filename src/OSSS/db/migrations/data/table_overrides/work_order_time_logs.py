# table_overrides/work_order_time_logs.py
import json
from __main__ import register_table_loader


@register_table_loader("work_order_time_logs")
def load_work_order_time_logs(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample work_order_time_logs"
