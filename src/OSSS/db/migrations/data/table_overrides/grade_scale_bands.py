# table_overrides/grade_scale_bands.py
import json
from __main__ import register_table_loader


@register_table_loader("grade_scale_bands")
def load_grade_scale_bands(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample grade_scale_bands"
