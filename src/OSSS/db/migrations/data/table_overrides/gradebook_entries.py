# table_overrides/gradebook_entries.py
import json
from __main__ import register_table_loader


@register_table_loader("gradebook_entries")
def load_gradebook_entries(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample gradebook_entries"
