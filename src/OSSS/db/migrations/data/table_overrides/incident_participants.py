# table_overrides/incident_participants.py
import json
from __main__ import register_table_loader


@register_table_loader("incident_participants")
def load_incident_participants(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample incident_participants"
