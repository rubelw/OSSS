# table_overrides/gl_segment_values.py
import json
from __main__ import register_table_loader


@register_table_loader("gl_segment_values")
def load_gl_segment_values(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample gl_segment_values"
