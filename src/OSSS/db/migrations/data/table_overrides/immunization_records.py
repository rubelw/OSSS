# table_overrides/immunization_records.py
import json
from __main__ import register_table_loader


@register_table_loader("immunization_records")
def load_immunization_records(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample immunization_records"
