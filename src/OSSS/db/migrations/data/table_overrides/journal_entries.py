# table_overrides/journal_entries.py
import json
from __main__ import register_table_loader


@register_table_loader("journal_entries")
def load_journal_entries(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample journal_entries"
