# table_overrides/behavior_interventions.py
import json
from __main__ import register_table_loader


@register_table_loader("behavior_interventions")
def load_behavior_interventions(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample behavior_interventions"
