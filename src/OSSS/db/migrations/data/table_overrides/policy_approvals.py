# table_overrides/policy_approvals.py
import json
from __main__ import register_table_loader


@register_table_loader("policy_approvals")
def load_policy_approvals(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample policy_approvals"
