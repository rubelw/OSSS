# table_overrides/unit_standard_map.py
import json
from __main__ import register_table_loader


@register_table_loader("unit_standard_map")
def load_unit_standard_map(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample unit_standard_map"
