# table_overrides/proposal_documents.py
import json
from __main__ import register_table_loader


@register_table_loader("proposal_documents")
def load_proposal_documents(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample proposal_documents"
