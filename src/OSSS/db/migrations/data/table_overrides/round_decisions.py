# table_overrides/round_decisions.py
import json
from __main__ import register_table_loader


@register_table_loader("round_decisions")
def load_round_decisions(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample round_decisions"
