# table_overrides/student_section_enrollments.py
import json
from __main__ import register_table_loader


@register_table_loader("student_section_enrollments")
def load_student_section_enrollments(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample student_section_enrollments"
