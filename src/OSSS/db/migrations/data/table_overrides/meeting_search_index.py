# table_overrides/meeting_search_index.py
import json
from __main__ import register_table_loader


@register_table_loader("meeting_search_index")
def load_meeting_search_index(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample meeting_search_index"
