# table_overrides/curriculum_versions.py
import json
from __main__ import register_table_loader


@register_table_loader("curriculum_versions")
def load_curriculum_versions(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample curriculum_versions"
