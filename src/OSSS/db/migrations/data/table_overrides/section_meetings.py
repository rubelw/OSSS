# table_overrides/section_meetings.py
import json
from __main__ import register_table_loader


@register_table_loader("section_meetings")
def load_section_meetings(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample section_meetings"
