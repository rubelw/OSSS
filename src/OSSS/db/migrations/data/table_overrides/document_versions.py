# table_overrides/document_versions.py
import json
from __main__ import register_table_loader


@register_table_loader("document_versions")
def load_document_versions(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample document_versions"
