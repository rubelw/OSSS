# table_overrides/pm_work_generators.py
import json
from __main__ import register_table_loader


@register_table_loader("pm_work_generators")
def load_pm_work_generators(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample pm_work_generators"
