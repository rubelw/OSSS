# table_overrides/work_order_tasks.py
import json
from __main__ import register_table_loader


@register_table_loader("work_order_tasks")
def load_work_order_tasks(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample work_order_tasks"
