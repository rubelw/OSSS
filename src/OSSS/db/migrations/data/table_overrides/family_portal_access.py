# table_overrides/family_portal_access.py
import json
from __main__ import register_table_loader


@register_table_loader("family_portal_access")
def load_family_portal_access(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample family_portal_access"
