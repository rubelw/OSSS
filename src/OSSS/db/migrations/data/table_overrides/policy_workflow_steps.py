# table_overrides/policy_workflow_steps.py
import json
from __main__ import register_table_loader


@register_table_loader("policy_workflow_steps")
def load_policy_workflow_steps(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample policy_workflow_steps"
