# table_overrides/document_activity.py
import json
from __main__ import register_table_loader


@register_table_loader("document_activity")
def load_document_activity(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample document_activity"
