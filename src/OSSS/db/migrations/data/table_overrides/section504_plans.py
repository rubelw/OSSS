# table_overrides/section504_plans.py
import json
from __main__ import register_table_loader


@register_table_loader("section504_plans")
def load_section504_plans(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample section504_plans"
