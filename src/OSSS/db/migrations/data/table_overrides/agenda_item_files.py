# table_overrides/agenda_item_files.py
import json
from __main__ import register_table_loader


@register_table_loader("agenda_item_files")
def load_agenda_item_files(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample agenda_item_files"
