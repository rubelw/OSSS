# table_overrides/health_profiles.py
import json
from __main__ import register_table_loader


@register_table_loader("health_profiles")
def load_health_profiles(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample health_profiles"
