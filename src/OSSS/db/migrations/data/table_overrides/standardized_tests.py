# table_overrides/standardized_tests.py
import json
from __main__ import register_table_loader


@register_table_loader("standardized_tests")
def load_standardized_tests(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample standardized_tests"
