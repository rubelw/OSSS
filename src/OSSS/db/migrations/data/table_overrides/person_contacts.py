# table_overrides/person_contacts.py
import json
from __main__ import register_table_loader


@register_table_loader("person_contacts")
def load_person_contacts(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample person_contacts"
