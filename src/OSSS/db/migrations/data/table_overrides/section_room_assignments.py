# table_overrides/section_room_assignments.py
import json
from __main__ import register_table_loader


@register_table_loader("section_room_assignments")
def load_section_room_assignments(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample section_room_assignments"
