# table_overrides/special_education_cases.py
import json
from __main__ import register_table_loader


@register_table_loader("special_education_cases")
def load_special_education_cases(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample special_education_cases"
