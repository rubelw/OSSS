# table_overrides/library_checkouts.py
import json
from __main__ import register_table_loader


@register_table_loader("library_checkouts")
def load_library_checkouts(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample library_checkouts"
