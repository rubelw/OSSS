# table_overrides/grading_periods.py
import json
from __main__ import register_table_loader


@register_table_loader("grading_periods")
def load_grading_periods(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample grading_periods"
