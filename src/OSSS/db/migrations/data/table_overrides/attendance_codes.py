# table_overrides/attendance_codes.py
import json
from __main__ import register_table_loader


@register_table_loader("attendance_codes")
def load_attendance_codes(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample attendance_codes"
