# table_overrides/student_transportation_assignments.py
import json
from __main__ import register_table_loader


@register_table_loader("student_transportation_assignments")
def load_student_transportation_assignments(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample student_transportation_assignments"
