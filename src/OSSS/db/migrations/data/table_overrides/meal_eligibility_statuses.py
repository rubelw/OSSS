# table_overrides/meal_eligibility_statuses.py
import json
from __main__ import register_table_loader


@register_table_loader("meal_eligibility_statuses")
def load_meal_eligibility_statuses(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample meal_eligibility_statuses"
