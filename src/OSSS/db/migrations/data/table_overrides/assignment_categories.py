# table_overrides/assignment_categories.py
import json
from __main__ import register_table_loader


@register_table_loader("assignment_categories")
def load_assignment_categories(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample assignment_categories"
