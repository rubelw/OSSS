# table_overrides/transcript_lines.py
import json
from __main__ import register_table_loader


@register_table_loader("transcript_lines")
def load_transcript_lines(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample transcript_lines"
