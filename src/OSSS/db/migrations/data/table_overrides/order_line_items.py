# table_overrides/order_line_items.py
import json
from __main__ import register_table_loader


@register_table_loader("order_line_items")
def load_order_line_items(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample order_line_items"
