# table_overrides/role_permissions.py
import json
from __main__ import register_table_loader


@register_table_loader("role_permissions")
def load_role_permissions(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample role_permissions"
