# table_overrides/student_program_enrollments.py
import json
from __main__ import register_table_loader


@register_table_loader("student_program_enrollments")
def load_student_program_enrollments(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample student_program_enrollments"
