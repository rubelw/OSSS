# table_overrides/sis_import_jobs.py
import json
from __main__ import register_table_loader


@register_table_loader("sis_import_jobs")
def load_sis_import_jobs(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample sis_import_jobs"
