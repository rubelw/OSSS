# table_overrides/curriculum_units.py
import json
from __main__ import register_table_loader


@register_table_loader("curriculum_units")
def load_curriculum_units(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample curriculum_units"
