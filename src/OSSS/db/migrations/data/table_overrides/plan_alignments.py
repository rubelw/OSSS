# table_overrides/plan_alignments.py
import json
from __main__ import register_table_loader


@register_table_loader("plan_alignments")
def load_plan_alignments(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample plan_alignments"
