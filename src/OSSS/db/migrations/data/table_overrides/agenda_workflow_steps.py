# table_overrides/agenda_workflow_steps.py
import json
from __main__ import register_table_loader


@register_table_loader("agenda_workflow_steps")
def load_agenda_workflow_steps(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample agenda_workflow_steps"
