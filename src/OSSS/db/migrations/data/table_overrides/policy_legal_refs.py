# table_overrides/policy_legal_refs.py
import json
from __main__ import register_table_loader


@register_table_loader("policy_legal_refs")
def load_policy_legal_refs(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample policy_legal_refs"
