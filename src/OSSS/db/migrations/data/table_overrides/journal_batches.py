# table_overrides/journal_batches.py
import json
from __main__ import register_table_loader


@register_table_loader("journal_batches")
def load_journal_batches(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample journal_batches"
