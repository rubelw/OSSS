# table_overrides/retention_rules.py
import json
from __main__ import register_table_loader


@register_table_loader("retention_rules")
def load_retention_rules(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample retention_rules"
