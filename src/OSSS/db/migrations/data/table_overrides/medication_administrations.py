# table_overrides/medication_administrations.py
import json
from __main__ import register_table_loader


@register_table_loader("medication_administrations")
def load_medication_administrations(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample medication_administrations"
