# table_overrides/data_quality_issues.py
import json
from __main__ import register_table_loader


@register_table_loader("data_quality_issues")
def load_data_quality_issues(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample data_quality_issues"
