# table_overrides/state_reporting_snapshots.py
import json
from __main__ import register_table_loader


@register_table_loader("state_reporting_snapshots")
def load_state_reporting_snapshots(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample state_reporting_snapshots"
