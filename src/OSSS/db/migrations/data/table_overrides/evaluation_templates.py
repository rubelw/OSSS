# table_overrides/evaluation_templates.py
import json
from __main__ import register_table_loader


@register_table_loader("evaluation_templates")
def load_evaluation_templates(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample evaluation_templates"
