# table_overrides/compliance_records.py
import json
from __main__ import register_table_loader


@register_table_loader("compliance_records")
def load_compliance_records(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample compliance_records"
