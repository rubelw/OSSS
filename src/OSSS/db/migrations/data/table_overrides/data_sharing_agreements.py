# table_overrides/data_sharing_agreements.py
import json
from __main__ import register_table_loader


@register_table_loader("data_sharing_agreements")
def load_data_sharing_agreements(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample data_sharing_agreements"
