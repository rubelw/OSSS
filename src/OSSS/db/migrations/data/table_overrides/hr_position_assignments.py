# table_overrides/hr_position_assignments.py
import json
from __main__ import register_table_loader


@register_table_loader("hr_position_assignments")
def load_hr_position_assignments(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample hr_position_assignments"
