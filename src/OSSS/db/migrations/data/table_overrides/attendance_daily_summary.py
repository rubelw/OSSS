# table_overrides/attendance_daily_summary.py
import json
from __main__ import register_table_loader


@register_table_loader("attendance_daily_summary")
def load_attendance_daily_summary(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample attendance_daily_summary"
