# table_overrides/governing_bodies.py
import json
from __main__ import register_table_loader


@register_table_loader("governing_bodies")
def load_governing_bodies(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample governing_bodies"
