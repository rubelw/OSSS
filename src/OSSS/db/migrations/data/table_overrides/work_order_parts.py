# table_overrides/work_order_parts.py
import json
from __main__ import register_table_loader


@register_table_loader("work_order_parts")
def load_work_order_parts(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample work_order_parts"
