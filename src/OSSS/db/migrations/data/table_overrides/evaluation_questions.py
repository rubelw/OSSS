# table_overrides/evaluation_questions.py
import json
from __main__ import register_table_loader


@register_table_loader("evaluation_questions")
def load_evaluation_questions(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample evaluation_questions"
