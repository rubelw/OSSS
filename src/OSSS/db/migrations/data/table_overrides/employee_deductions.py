# table_overrides/employee_deductions.py
import json
from __main__ import register_table_loader


@register_table_loader("employee_deductions")
def load_employee_deductions(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample employee_deductions"
