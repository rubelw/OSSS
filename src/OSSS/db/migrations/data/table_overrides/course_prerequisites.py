# table_overrides/course_prerequisites.py
import json
from __main__ import register_table_loader


@register_table_loader("course_prerequisites")
def load_course_prerequisites(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample course_prerequisites"
