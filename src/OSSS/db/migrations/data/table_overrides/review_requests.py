# table_overrides/review_requests.py
import json
from __main__ import register_table_loader


@register_table_loader("review_requests")
def load_review_requests(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample review_requests"
