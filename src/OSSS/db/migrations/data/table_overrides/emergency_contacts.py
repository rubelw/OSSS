# table_overrides/emergency_contacts.py
import json
from __main__ import register_table_loader


@register_table_loader("emergency_contacts")
def load_emergency_contacts(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample emergency_contacts"
