# table_overrides/employee_earnings.py
import json
from __main__ import register_table_loader


@register_table_loader("employee_earnings")
def load_employee_earnings(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample employee_earnings"
