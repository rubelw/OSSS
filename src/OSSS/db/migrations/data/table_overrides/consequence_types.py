# table_overrides/consequence_types.py
import json
from __main__ import register_table_loader


@register_table_loader("consequence_types")
def load_consequence_types(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample consequence_types"
