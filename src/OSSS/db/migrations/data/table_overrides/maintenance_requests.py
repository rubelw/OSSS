# table_overrides/maintenance_requests.py
import json
from __main__ import register_table_loader


@register_table_loader("maintenance_requests")
def load_maintenance_requests(table, enums, csv_rows):
            ...
            for col in table.columns:
                ...
                if raw_val not in (None, ""):
                    ...
                    if col_name == "active":
                        ...
                        row[col_name] = "Sample maintenance_requests"
