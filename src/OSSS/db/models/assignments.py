...
class Assignment(UUIDMixin, Base):
    ...
    NOTE: ClassVar[str] =     (
        ...
        "description=Stores assignments records for the application. "
        "Key attributes include name. "
        "References related entities via: category, section. "
    ...
    __table_args__ = {
        "comment":         (
            "Stores assignments records for the application. "
            "Key attributes include name. "
            "References related entities via: category, section. "
            "Includes standard audit timestamps (created_at, updated_at). "
            "8 column(s) defined. "
