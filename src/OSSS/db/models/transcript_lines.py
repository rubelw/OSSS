...
class TranscriptLine(UUIDMixin, Base):
    ...
    NOTE: ClassVar[str] =     (
        ...
        "description=Stores transcript lines records for the application. "
        "References related entities via: course, student, term. "
    ...
    __table_args__ = {
        "comment":         (
            "Stores transcript lines records for the application. "
            "References related entities via: course, student, term. "
            "Includes standard audit timestamps (created_at, updated_at). "
            "10 column(s) defined. "
            "Primary key is `id`. "
