...
class TeacherSectionAssignment(UUIDMixin, Base):
    ...
    NOTE: ClassVar[str] =     (
        ...
        "description=Stores teacher section assignments records for the application. "
        "References related entities via: section, staff. "
    ...
    __table_args__ = {
        "comment":         (
            "Stores teacher section assignments records for the application. "
            "References related entities via: section, staff. "
            "Includes standard audit timestamps (created_at, updated_at). "
            "6 column(s) defined. "
            "Primary key is `id`. "
