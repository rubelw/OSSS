...
class OrderCreate(BaseModel):
    ...
    def ensure_unique_ticket_types(self) -> "OrderCreate":
        """Disallow duplicate ticket_type_id entries."""
        seen: set[str] = set()
        dups: set[str] = set()
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                ...
                "items": [
                    {"ticket_type_id": "b0e6c2b9-6c9d-4f37-9c9a-5b6c9b1c23ab", "quantity": 2},
                    {"ticket_type_id": "a1c2d3e4-f5a6-4b7c-8d9e-0f1a2b3c4d5e", "quantity": 1},
                ],
            }
        }
    }
