...
class GradebookEntry(UUIDMixin, Base):
    ...
    NOTE: ClassVar[str] =     (
        ...
        "description=Stores gradebook entries records for the application. "
        "References related entities via: assignment, student. "
    ...
    __table_args__ = {
        "comment":         (
            "Stores gradebook entries records for the application. "
            "References related entities via: assignment, student. "
            "Includes standard audit timestamps (created_at, updated_at). "
            "8 column(s) defined. "
            "Primary key is `id`. "
