...
class RolePermission(Base):
    ...
    NOTE: ClassVar[str] =     (
        ...
        "description=Stores role permissions records for the application. "
        "References related entities via: permission, role. "
    ...
    __table_args__ = {
        "comment":         (
            "Stores role permissions records for the application. "
            "References related entities via: permission, role. "
            "Includes standard audit timestamps (created_at, updated_at). "
            "5 column(s) defined. "
            "Primary key is `id`. "
