...
from OSSS.ai.database.models import Base
from OSSS.ai.database.config import get_database_config
...
config.set_main_option("sqlalchemy.url", db_config.get_sync_url())
