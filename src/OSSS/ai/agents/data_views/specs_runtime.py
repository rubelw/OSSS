# src/OSSS/ai/agents/data_views/specs_runtime.py
...
class DataViewSpec:
    ...
    store_key: str = "data_view_result"
    max_rows: int = 200


def build_specs_from_app(app: FastAPI, *, base_url: str) -> dict[str, DataViewSpec]:
