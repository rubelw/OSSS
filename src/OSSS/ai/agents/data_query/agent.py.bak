...
class DataQueryAgent(BaseAgent):
    ...
    async def run(self, context: AgentContext) -> AgentContext:
        ...
        # --------------------------
        crud_verbs = {"create", "update", "delete", "patch"}
        ...
        if intent in {"create", "update", "delete", "patch"}:
            ...
            content_str = (
                ...
                "Is that the correct table? You can reply 'yes', 'no', or provide a different table name."
            )
            meta_block = {
                "action": "wizard",
                "step": "confirm_table",
        ...
        try:
            ...
            rows_compact = _shrink_to_ui_defaults(rows_full, query_spec)
            status_code = 200
