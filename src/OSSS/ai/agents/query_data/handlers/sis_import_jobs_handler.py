...
logger = logging.getLogger("OSSS.ai.agents.query_data.sis_import_jobs")
...
class SisImportJobsHandler(QueryHandler):
    ...
    def to_markdown(self, rows: List[Dict[str, Any]]) -> str:
        return _build_sis_import_jobs_markdown_table(rows)

    def to_csv(self, rows: List[Dict[str, Any]]) -> str:
        return _build_sis_import_jobs_csv(rows)


# register on import
register_handler(SisImportJobsHandler())
