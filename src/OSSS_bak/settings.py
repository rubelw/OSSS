...
from pydantic import AnyUrl, Field, AliasChoices, SecretStr
...
class Settings(BaseSettings):
    ...
    callback_url: AnyUrl = Field(
        default="http://localhost:8081/callback",  # <-- fixed
        validation_alias=AliasChoices("CALLBACK_URL", "OSSS_CALLBACK_URL"),
    )
